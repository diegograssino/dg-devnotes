      ...
      <Text paddingBottom={3}>
        ...
        <List spacing={2}>
          ...
          <ListItem>
            ...
            este disponible (generalmente entre 2 y 6 horas), ¡puedo revisarla
            las vecees que quiera!
          </ListItem>
          <ListItem fontWeight={700}>
            <ListIcon as={FaQuestionCircle} color="green.500" />
          ...
          <ListItem>
            ...
            enfoque y funcionalidades que superan al JS Vainilla. Vamos a
            utilizar Firebase como base de datos y backend, es un servicio cloud
            de Google que podemos consumir directamente, no es complejo y es
            bastante util, es por esto que no hace falta que sepan nada de
            backend y tampoco podremos elegir hacerlo con otra herramienta
            (salvo que el profesor les de el Ok, algo que no suele pasar). Es
            importante saber que tenemos que ajustarnos al contenido, porque el
            contenido se ajusta a los desafios y a las entregas.
          </ListItem>
          <ListItem fontWeight={700}>
            <ListIcon as={FaQuestionCircle} color="green.500" />
          ...
          <ListItem>
            ...
            necesito conocer Javascript, HTML y CSS, no hace falta ser un
            experto ni saber todo esto al 100% (siempre hay lugar para repasos o
